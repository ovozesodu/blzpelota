...
public struct PelotaSignalProbePayload: Codable, Equatable, Sendable {
...
public struct PelotaSignalLaunchPayload: Codable, Equatable, Sendable {
...
public struct PelotaSignalDecision: Decodable, Equatable, Sendable {
...
private extension KeyedDecodingContainer where Key == PelotaSignalDecision.CodingKeys {
